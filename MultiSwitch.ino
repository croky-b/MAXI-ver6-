...
if (pulseWidth[MULTI_1_CH-1] < DOWN1_MAX && pulseWidth[MULTI_1_CH-1] > DOWN1_MIN){
 if (millis() - MultiMillis > 250){
  Multi1Down =true;
...
if (pulseWidth[MULTI_1_CH-1] < DOWN2_MAX && pulseWidth[MULTI_1_CH-1] > DOWN2_MIN){
 if (millis() - MultiMillis > 250){
  Multi2Down =true;
...
if (pulseWidth[MULTI_1_CH-1] < DOWN3_MAX && pulseWidth[MULTI_1_CH-1] > DOWN3_MIN){
 if (millis() - MultiMillis > 250){
  Multi3Down =true;
...
if (pulseWidth[MULTI_1_CH-1] < DOWN4_MAX && pulseWidth[MULTI_1_CH-1] > DOWN4_MIN){
 if (millis() - MultiMillis > 250){
  Multi4Down =true;
